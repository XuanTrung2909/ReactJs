...
export default class RenderPhim extends Component {
    ...
    renderPhim = () => {
        let contentPhim = this.dataPhim.map((phim, index) => {
            return <div className="col-4" key={index}>
                        <div class="card text-left">
                            <img class="card-img-top" src={phim.hinhAnh} alt={phim.tenPhim}/>
                            <div class="card-body">
                                <h4 class="card-title" style={{height:50}}>{phim.tenPhim}</h4>
                                <p class="card-text" style={{height:70}}>{phim.moTa}</p>
                            </div>
                        </div>
                    </div>
        })
