...
import BTKinhContent from './BTKinhContent';
import BTKinhHeader from './BTKinhHeader'

export default class BTKinh extends Component {
    ...
    render() {
        return (
            <div>
                <BTKinhHeader />
                <BTKinhContent arrProduct = {this.arrProduct}/>
            </div>
        )
    }
}
